    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ManyToManyField(related_name='tickets', to='main.Category', verbose_name='Категория')),
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tickets', to='main.seller', verbose_name='Продавец')),
                ('tag', models.ManyToManyField(related_name='tickets', to='main.Tag', verbose_name='Тег')),
            ],
            options={
                'verbose_name': 'Билет',
